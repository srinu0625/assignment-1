# Short-side only MACD + RSI Logic
import pandas as pd
import time
import os
import re
...
for i in range(26, len(df)):
    try:
        ...
        # SHORT ENTRY
        if macd < signal and rsi > 80 and position == 0:
        ...
        # SHORT EXIT
        elif position == 2 and macd > signal and rsi < 40:
...
if match:
    ...
    print(f"\n\033[1mTrading Performance Summary for {product} {timeframe} (Short-side Only):\033[0m")
else:
    print("\n\033[1mTrading Performance Summary (Short-side Only):\033[0m")
