...
previous_local_low1=0
previous_local_high1=0
previous_local_low2=0
previous_local_high2=0
                    ...
                    if current_date2 == current_date1:
                        #try:
                            ...
                            if(current_high1 > previous_high1):
                                ...
                                local_low1 = temp_low1
                                previous_local_low1 = local_low1
                            ...
                            if(current_low1 < previous_low1):
                                ...
                                local_high1 = temp_high1
                                previous_local_high1 = local_high1
                            ...
                            if(current_high2 > previous_high2):
                                ...
                                local_low2 = temp_low2
                                previous_local_low2 = local_low2

                            # case 2 for data1-----------------------------------------------------------------------------------
                            if(current_low2 < previous_low2):
                                temp_low2 = current_low2
                                local_high2 = temp_high2
                                previous_local_high2 = local_high2
                            ...
                            if current_high1 > local_high1 and  local_low1 > previous_local_low1 and local_low1 > local_low2 and local_low1 > current_low2 and local_high1 != 0 and local_low1 != 0 and local_high2 != 0 and local_low2 != 0 and not bear and not flag:
                                if max_loss_for_trade > risk:
                                   ...
                                   continue  # Skip this trade
                                    ...
                                    print("\033[32m<------ LONG ENTRY ------> (LL1 > LL2 and LL1 > CL2)\033[0m")  # ANSI escape codes for this color coding to work
                            ...
                            # bearish candle-------------------------------------------------------------------------
                            max_loss_for_trade = (local_high1 - local_low1 + ( tick_val * 4)) * contract_size
                            if current_low1 < local_low1 and  local_high1 < previous_local_high1 and local_low1 > local_low2 and local_low1 > current_low2 and local_high1 != 0 and local_low1 != 0 and local_high2 != 0 and local_low2 != 0 and not bear and not flag:
                                if max_loss_for_trade > risk:
                                   num_of_lots = 1
                                   continue  # Skip this trade
                                else:
                                    ...
                                    print("\033[31m<------ SHORT ENTRY ------> (LH1 < LL2 and LH1 < CH2)\033[0m")  # ANSI escape codes for this color coding to work
                                    print("        ENTRY PRICE = ", entry_price)
                                    print("   num_of_positions = ", number_of_positions)
                                    print("        num_of_lots = ",round(num_of_lots))
                                    print(" max_loss_for_trade = ",round(max_loss_for_trade))
