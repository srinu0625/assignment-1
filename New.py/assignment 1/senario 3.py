            ...
            if pd.notna(row2[time_column_name]) and pd.notna(row2[high_column_name]) and pd.notna(row2[low_column_name]):
                ...
                if current_date2 == current_date1:
                    try:
                        ...
                        # Bullish entry-------------------
                        if local_high1 > 0:
                            if (local_low1 > prev_local_low1) and ((local_low1 < local_low2) or (local_low1 > local_high2)) and (current_high1 > previous_high1) and not bear and not flag:
                        ...
                        # bearish candle-------------------------------------------------------------------------
                        if local_low1 > 0:
                            if (local_high1 < prev_local_high1) and ((local_high1 > local_high2) or (local_high1 < local_low2 ))and(current_low1 < previous_low1) and not bull and not flag:
