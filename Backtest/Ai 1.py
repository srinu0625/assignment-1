                    ...
                    try:
                        ...
                        if local_high1 > 0:
                            if (current_high1 > local_high1) and (local_low1 >= local_low2) and not bear and not flag:
                                ...
                                if (current_high1 > local_high1) and (local_low1 >= local_low2)  and (current_high1 > previous_high1) and (current_low1 < previous_low1) and not bear and not flag:
                        ...
                        if local_low1 > 0:
                            if (current_low1 < local_low1) and (local_high1 <= local_high2) and not bull and not flag:
                                ...
                                if (current_low1 < local_low1) and (local_high1 <= local_high2) and (current_high1 > previous_high1) and (current_low1 < previous_low1)  and not bull and not flag:
