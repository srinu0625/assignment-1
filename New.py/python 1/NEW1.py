...
file_path2 = r"C:\Users\lenovo\Desktop\ES DAY..csv"
...
if "ES" or "es" in file_path1:
    contract_size = 5
    tick_val = 0.25

if "NQ" or "nq" in file_path1:
    contract_size = 2
    tick_val = 0.25

if "YM" or "ym" in file_path1:
    contract_size = 0.5
    tick_val = 1

if "CL" or "cl" in file_path1:
    contract_size = 100
    tick_val = 0.01

if "BT" or "bt" in file_path1:
    contract_size = 0.1
    tick_val = 5

if "GC" or "gc" in file_path1:
    contract_size = 10
    tick_val = 0.1
