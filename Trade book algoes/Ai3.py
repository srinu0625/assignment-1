...
plt.title('Correlation Matrix of energies Daily')

# Save the plot as a file (e.g., PNG) in the desired directory
save_path = r"D:\PNL output\correlation of energies Daily.png"  # Update the path here
